        ...
        <SafeAreaView>
          <View style={styles.headerContent}>
            <View style={styles.profileRow}>
              ...
              <Image 
                source={{ uri: 'https://via.placeholder.com/100x50' }} // Replace with actual logo asset if known
                style={styles.logo}
                resizeMode="contain"
              />
            </View>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.tabsScroll}>
              {['All', 'My Sessions', 'Requests', 'Services'].map((tab, index) => (
                <TouchableOpacity 
                  key={index} 
                  style={[styles.tabItem, index === 0 ? styles.activeTabItem : styles.inactiveTabItem]}
                >
                  {index === 0 && <AntDesign name="appstore-o" size={16} color="#fff" style={{marginRight: 6}} />}
