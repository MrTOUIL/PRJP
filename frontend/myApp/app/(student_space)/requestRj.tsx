			...
			<ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
				<View style={styles.cardWrap}>
					...
					<View style={styles.statusBadge}>
						<Ionicons name="close" size={34} color="#DC2626" />
					</View>
					<Text style={styles.statusTitle}>Quote rejected</Text>
					<Text style={styles.statusSubtitle}>Your request has not been approved</Text>
				</View>
				...
				<TouchableOpacity style={[styles.deleteButton, styles.deleteButtonBottom]}>
