...
export default function servicREq() {
				...
				<View style={styles.sectionCard}>
					...
					<View style={styles.teacherCard}>
						<View style={styles.teacherAvatar}>
							<Text style={styles.teacherAvatarText}>{tutorInfo.name.charAt(0).toUpperCase()}</Text>
						</View>
						<View style={styles.teacherContent}>
							<Text style={styles.teacherName}>{tutorInfo.name}</Text>
							<Text style={styles.teacherMeta}>{tutorInfo.meta} · {targetAudience}</Text>
						</View>
