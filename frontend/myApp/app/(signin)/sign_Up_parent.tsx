...
export default function StudentRegister() {
    ...
    const [parentl , setParentl] = useState("") ;
    ...
    const handleRegister = ():void => {
        setMsg("") ; 
        setLoading(true) ; 
        fetch("https://localhost:5000/logs/register_parent",{
            method:"POST",
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.header}>
                    ...
                    >
                        <Text style={styles.headerTitle}>Parent/Student Profile</Text>
                    ...
                    <View style={styles.fieldGroup}>
                        <View style={styles.row}>
                            <View style={styles.col}>
                                <FieldLabel label="student First Name" required />
                                <InputRow
                                    icon="pencil"
                            ...
                            <View style={styles.col}>
                                <FieldLabel label="Student Last Name" required />
                                <InputRow
                                    icon="pencil"
                        ...
                        <view style={styles.row}>
                            <View style={styles.col}>
                                ...
                                <InputRow
                                    ...
                                    placeholder="first name"
                                    value={parentf}
                                    onChangeText={(text: string) => setParentf(text)}
                                />
                            </View>
                            <View style={styles.col}>
                                <FieldLabel label="Parent Last Name" required />
                                <InputRow
                                    icon="pencil"
                                    placeholder="Last name"
                                    value={parentl}
